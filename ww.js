...
(function(){
    ...
    ww.Roles = {
        PendudukLokal: {desc:"PendudukLokal", nightActionReq:0, team:"Good", imgClass:"bgRoleVillager"},
        Pembunuh: {desc:"Pembunuh", nightActionReq:1, team:"Evil", imgClass:"bgRoleWerewolf"},
        Saksi: {desc:"Saksi", nightActionReq:1, team:"Good", imgClass:"bgRoleSeer"},
    ...
    ww.Roles.Saksi.viewFor = ww.Roles.Pembunuh;
    ww.Roles.Sorcerer.viewFor = ww.Roles.Saksi;
    ...
    ww.Rolesets = [
        {name:"Basic 5 player",
            ...
            roles: [
                {role:ww.Roles.Pembunuh, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.RandomNegative, count: 1},
                {role:ww.Roles.PendudukLokal, count: 3}
            ]
        },
        {name:"Must lynch",
            ...
            reveal: ww.DeathReveal.Full,
            roles: [
                {role:ww.Roles.Pembunuh, count: 2},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.ChooseView, count: 1},
                {role:ww.Roles.PendudukLokal, count: 2}
            ]
        },
        {name:"Fiver",
            desc:"1 pembunuh, 1 sorcerer, 1 seer, 1 hunter, 1 villager.  Choose your views the first night, no reveal on death.",
            players: 5,
            reveal: ww.DeathReveal.None,
            roles: [
                {role:ww.Roles.Pembunuh, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.ChooseView, count: 1},
                {role:ww.Roles.PendudukLokal, count: 1},
        ...
        {name:"Five Seers",
            ...
            roles: [
                {role:ww.Roles.Pembunuh, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.ChooseView, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.ChooseView, attributes: [ww.Attributes.Insane], knownAttributes: false, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.ChooseView, attributes: [ww.Attributes.Paranoid], knownAttributes: false, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.ChooseView, attributes: [ww.Attributes.Naive], knownAttributes: false, count: 1}
            ]
        },
        {name:"Basic 6 player",
            ...
            roles: [
                {role:ww.Roles.Pembunuh, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.RandomNegative, count: 1},
                {role:ww.Roles.PendudukLokal, count: 4}
            ]
        },
        {name:"Six Seers",
        ...
        {name:"Basic 7 player",
            ...
            roles: [
                {role:ww.Roles.Pembunuh, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.RandomNegative, count: 1},
                {role:ww.Roles.PendudukLokal, count: 5}
            ]
        },
        ...
        {name:"Seven Seers Tinker",
            ...
            roles: [
                ...
                {role:ww.Roles.Saksi, n0:ww.N0Actions.ChooseView, attributes: [ww.Attributes.Paranoid], knownAttributes: false, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.ChooseView, attributes: [ww.Attributes.Naive], knownAttributes: false, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.ChooseView, attributes: [ww.Attributes.Naive, ww.Attributes.Tinker], knownAttributes: false, count: 1}
            ]
        },
        {name:"Basic 8 player",
            ...
            roles: [
                {role:ww.Roles.Pembunuh, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.RandomNegative, count: 1},
                {role:ww.Roles.PendudukLokal, count: 6}
            ]
        },
        ...
        {name:"Basic 10 player",
            ...
            roles: [
                {role:ww.Roles.Pembunuh, count: 2},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.RandomNegative, count: 1},
                {role:ww.Roles.PendudukLokal, count: 7}
            ]
        },
        ...
        {name:"Valley of the Seers Tinker",
            ...
            roles: [
                ...
                {role:ww.Roles.Sorcerer, n0:ww.N0Actions.ChooseView, count: 1},
                {role:ww.Roles.PendudukLokal, count: 2},
                {role:ww.Roles.PendudukLokal, attributes: [ww.Attributes.Tinker], knownAttributes: false, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.ChooseView, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.ChooseView, attributes: [ww.Attributes.Insane], knownAttributes: false, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.ChooseView, attributes: [ww.Attributes.Paranoid], knownAttributes: false, count: 1},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.ChooseView, attributes: [ww.Attributes.Naive], knownAttributes: false, count: 1}
        ...
        {name:"Basic 11 player",
            ...
            roles: [
                {role:ww.Roles.Pembunuh, count: 2},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.RandomNegative, count: 1},
                {role:ww.Roles.PendudukLokal, count: 8}
            ]
        },
        ...
        {name:"Basic 12 player",
            ...
            roles: [
                {role:ww.Roles.Pembunuh, count: 2},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.RandomNegative, count: 1},
                {role:ww.Roles.PendudukLokal, count: 9}
            ]
        },
        ...
        {name:"Basic 13 player",
            ...
            reveal: ww.DeathReveal.Full,
            roles: [
                {role:ww.Roles.Pembunuh, count: 3},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.RandomNegative, count: 1},
                {role:ww.Roles.PendudukLokal, count: 9}
            ]
        },
        ...
        {name:"Basic 14 player",
            ...
            roles: [
                {role:ww.Roles.Pembunuh, count: 3},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.RandomNegative, count: 1},
                {role:ww.Roles.PendudukLokal, count: 10}
            ]
        },
        ...
        {name:"Basic 15 player",
            ...
            roles: [
                {role:ww.Roles.Pembunuh, count: 3},
                {role:ww.Roles.Saksi, n0:ww.N0Actions.RandomNegative, count: 1},
                {role:ww.Roles.PendudukLokal, count: 11}
            ]
        },
